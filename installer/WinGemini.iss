...
UninstallDisplayIcon={app}\WinGemini.exe
...
[Files]
Source: "{#SourceDir}\WinGemini.exe"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\WinGemini.exe"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\WinGemini.exe"; Tasks: desktopicon
...
Filename: "{app}\WinGemini.exe"; Description: "Launch {#MyAppName}"; Flags: nowait postinstall skipifsilent
